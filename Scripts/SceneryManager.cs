...
public class SceneryManager
{
    ...
    private void CreateScenery()
    {
        ...
        for (int i = 0; i < 20; i++)
        {
            ...
            rockMat.AlbedoColor = new Color(0.52f + rng.RandfRange(0, 0.06f), 0.5f + rng.RandfRange(0, 0.05f), 0.46f + rng.RandfRange(0, 0.04f));
    ...
    private void AddHouse(float z, float offset, RandomNumberGenerator rng)
    {
        ...
        var wallColors = new[] {
            new Color(0.94f, 0.92f, 0.85f),  // white clapboard
            new Color(0.9f, 0.8f, 0.65f),    // cream
            new Color(0.75f, 0.88f, 0.8f),   // sage green
    ...
    private void CreateClouds()
    {
        ...
        for (int i = 0; i < 25; i++)
        {
            ...
            cloudMat.AlbedoColor = new Color(0.97f, 0.97f, 0.99f, 0.8f);
    ...
    private void CreateButterflies()
    {
        ...
        var colors = new[] {
            ...
            new Color(0.7f, 0.85f, 0.95f), // blue
            new Color(0.95f, 0.95f, 0.9f), // white
        };
